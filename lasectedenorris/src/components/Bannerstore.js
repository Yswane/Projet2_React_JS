...
class Bannerstore extends Component {
  ...
  render() {
    ...
    return (
      ...
      <a href="/Shop" Target="_blank" class="button_store" title="Achèèètes"><Link to="/Shop" />Choppe Chuck  <span class="icon-play"><i class="fas fa-chevron-circle-right"></i></span></a>
      </div>
      </div>
    );
  }
