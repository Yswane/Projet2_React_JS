    ...
    return (
      <div className="banner_store">
        ...
        <div className="text_ban_store">
          ...
          <a href="/Shop" Target="_blank" className="button_store" title="Achèèètes"><Link to="/Shop" />Shop Chuck <span class="icon-play"><i class="fas fa-chevron-circle-right"></i></span></a>
        </div>
      </div>
    );
  }
