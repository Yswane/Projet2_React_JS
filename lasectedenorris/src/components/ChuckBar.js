        ...
        <header className="NavBarStart haut">
          ...
          <div className="main-nav-container">
            <ul className="Main-nav">
              <li><a href="./src/screen/Home.js" onClick={this.props.gunSound}><NavLink exact to="/"> Accueil</NavLink></a></li>
              <li><a href="./src/screen/Shop.js" onClick={this.props.gunSound}><NavLink exact to="/Shop"> Magasin </NavLink></a></li>
              <li className="LiImageChuck"><a href="./src/screen/Home.js" onClick={this.props.gunSound}> <img  src="https://image.noelshack.com/fichiers/2019/14/3/1554323367-kisspng-globe-life-park-in-arlington-texas-rangers-texas-r-texas-rangers-5b0efe2ebf2f32-1568870215277092307831.png" alt=" de chuck"></img></a></li>
