...
class Chuckbanner extends Component {
  ...
  render() {
    ...
    return (
      ...
      <p>Chuck Norris est devenu malgré lui un meme sur Internet. De très nombreux aphorismes humoristiques, les « Chuck Norris Facts », lui attribuent en effet des qualités surhumaines, caricaturant les héros forts et virils qu'il a interprétés au cinéma et à la télévision. Ces courts énoncés de ses hauts faits vont même jusqu'à présenter comme évidente la supériorité de Chuck Norris, Exemple : Chuck Norris a déjà compté jusqu'à l'infini. Deux fois.. Les thèmes abordés sont très variés, et certains ensembles de facts font référence à des connaissances pointues, ayant généralement été conçus par des étudiants spécialisés dans la discipline correspondante. </p>
